...
pdb_file = DATA_DIR + '/pdb_data/mmcif_files/5on6.cif' # can be either .cif or .pdb # 1jux.cif
mtz_file = DATA_DIR + '/pdb_data/mtz_files/5on6.mtz' # ground truth download from the PDB for comparison # 1jux.mtz
